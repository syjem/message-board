      ...
      <div className="rounded-xl overflow-hidden w-full h-[572px] bg-gray-800">
        ...
        <div className="relative flex flex-col h-[calc(100%-115px)]">
          <div className="flex-1 p-4 space-y-8">
            <Skeleton className="bg-gray-500/50 rounded-b-xl rounded-l-none rounded-r-xl h-28 w-1/2" />
            <Skeleton className="bg-gray-500/50 rounded-b-xl rounded-l-none rounded-r-xl h-16 w-[280px]" />
          </div>
